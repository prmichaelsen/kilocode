...
export declare class FileWatcher implements IFileWatcher {
     ...
     */
    constructor(workspacePath: string, context: vscode.ExtensionContext, cacheManager: CacheManager, embedder?: IEmbedder, vectorStore?: IVectorStore, ignoreInstance?: Ignore, ignoreController?: RooIgnoreController, batchSegmentThreshold?: number);
    /**
