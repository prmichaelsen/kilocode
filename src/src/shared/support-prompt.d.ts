...
type SupportPromptType = "ENHANCE" | "CONDENSE" | "EXPLAIN" | "FIX" | "IMPROVE" | "ADD_TO_CONTEXT" | "TERMINAL_ADD_TO_CONTEXT" | "TERMINAL_FIX" | "TERMINAL_EXPLAIN" | "TERMINAL_GENERATE" | "NEW_TASK" | "COMMIT_MESSAGE";
