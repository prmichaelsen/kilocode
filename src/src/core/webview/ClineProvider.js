...
export class ClineProvider extends EventEmitter {
    ...
    settingsImportedAt;
    latestAnnouncementId = "sep-2025-code-supernova-1m"; // Code Supernova 1M context window announcement
    ...
    */
    ...
    async getStateToPostToWebview() {
        ...
        maxReadFileLine, maxImageFileSize, maxTotalImageSize, terminalCompressProgressBar, historyPreviewCollapsed, reasoningBlockCollapsed, cloudUserInfo, cloudIsAuthenticated, sharingEnabled, organizationAllowList, organizationSettingsVersion, maxConcurrentFileReads, allowVeryLargeReads, // kilocode_change
        ...
        try {
            ...
            console.error(`[getStateToPostToWebview] failed to get cloud organizations: ${error instanceof Error ? error.message : String(error)}`);
        }
