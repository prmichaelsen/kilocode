...
describe("isToolAllowedForMode", () => {
	...
	it("allows always available tools", () => {
		expect((0, modes_1.isToolAllowedForMode)("ask_followup_question", "markdown-editor", customModes)).toBe(true)
		expect((0, modes_1.isToolAllowedForMode)("attempt_completion", "markdown-editor", customModes)).toBe(true)
	})
	it("allows unrestricted tools", () => {
		expect((0, modes_1.isToolAllowedForMode)("read_file", "markdown-editor", customModes)).toBe(true)
		expect((0, modes_1.isToolAllowedForMode)("browser_action", "markdown-editor", customModes)).toBe(true)
	})
	describe("file restrictions", () => {
		it("allows editing matching files", () => {
			// Test markdown editor mode
			const mdResult = (0, modes_1.isToolAllowedForMode)(
				"write_to_file",
				"markdown-editor",
				customModes,
				undefined,
			...
			const cssResult = (0, modes_1.isToolAllowedForMode)("write_to_file", "css-editor", customModes, undefined, {
				path: "styles.css",
		...
		it("rejects editing non-matching files", () => {
			...
			expect(() =>
				(0, modes_1.isToolAllowedForMode)("write_to_file", "markdown-editor", customModes, undefined, {
					path: "test.js",
			...
			expect(() =>
				(0, modes_1.isToolAllowedForMode)("write_to_file", "css-editor", customModes, undefined, {
					path: "test.js",
					content: "console.log('test')",
				}),
			).toThrow(modes_1.FileRestrictionError)
		...
		it("handles partial streaming cases (path only, no content/diff)", () => {
			...
			expect(
				(0, modes_1.isToolAllowedForMode)("apply_diff", "markdown-editor", customModes, undefined, {
					path: "test.js",
				}),
			).toBe(true)
			// Should allow path-only for architect mode too
			expect(
				(0, modes_1.isToolAllowedForMode)("write_to_file", "architect", [], undefined, {
					path: "test.js",
				}),
			).toBe(true)
		})
		it("applies restrictions to both write_to_file and apply_diff", () => {
			// Test write_to_file
			const writeResult = (0, modes_1.isToolAllowedForMode)(
				"write_to_file",
				"markdown-editor",
				customModes,
				undefined,
			...
			// Test apply_diff
			const diffResult = (0, modes_1.isToolAllowedForMode)(
				"apply_diff",
				"markdown-editor",
				customModes,
				undefined,
		...
		it("uses description in file restriction error for custom modes", () => {
			...
			expect(() =>
				(0, modes_1.isToolAllowedForMode)("apply_diff", "docs-editor", customModesWithDescription, undefined, {
					path: "test.js",
					diff: "- old\n+ new",
				}),
			).toThrow(modes_1.FileRestrictionError)
		...
		it("allows architect mode to edit markdown files only", () => {
			...
			expect(
				(0, modes_1.isToolAllowedForMode)("apply_diff", "architect", [], undefined, {
					path: "readme.md",
					diff: "- old\n+ new",
				}),
			).toBe(true)
			...
			expect((0, modes_1.isToolAllowedForMode)("read_file", "architect", [])).toBe(true)
			expect((0, modes_1.isToolAllowedForMode)("browser_action", "architect", [])).toBe(true)
			expect((0, modes_1.isToolAllowedForMode)("use_mcp_tool", "architect", [])).toBe(true)
		})
		it("applies restrictions to all edit tools including search_and_replace and insert_content", () => {
			...
			expect(
				(0, modes_1.isToolAllowedForMode)("search_and_replace", "architect", [], undefined, {
					path: "test.md",
					search: "old text",
					replace: "new text",
				}),
			...
			expect(
				(0, modes_1.isToolAllowedForMode)("insert_content", "architect", [], undefined, {
					path: "test.md",
					line: "1",
					content: "# New content",
				}),
	...
	it("handles non-existent modes", () => {
		expect((0, modes_1.isToolAllowedForMode)("write_to_file", "non-existent", customModes)).toBe(false)
	})
	it("respects tool requirements", () => {
		...
		expect(
			(0, modes_1.isToolAllowedForMode)("write_to_file", "markdown-editor", customModes, toolRequirements),
		).toBe(false)
	})
})
