...
exports.isAlphaPeriodEndedError = isAlphaPeriodEndedError
exports.isModelNotAllowedForTeamError = isModelNotAllowedForTeamError
exports.isAnyRecognizedKiloCodeError = isAnyRecognizedKiloCodeError
...
function isAlphaPeriodEndedError(error) {
	return !!(
		error &&
		error.status === 404 &&
...
function isModelNotAllowedForTeamError(error) {
...
function isAnyRecognizedKiloCodeError(error) {
	return (
