...
exports.createAndOpenGitHubIssue = createAndOpenGitHubIssue
 ...
 */
function createGitHubIssueUrl(baseUrl, params) {
 ...
 * @param params Map of parameter names to values for the issue form
 */
async function createAndOpenGitHubIssue(repoOwner, repoName, issueTemplate, params) {
