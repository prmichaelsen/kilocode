...
exports.getKeybindingsForCommands = getKeybindingsForCommands
exports.getKeybindingForCommand = getKeybindingForCommand
exports.getDefaultKeybindingForCommand = getDefaultKeybindingForCommand
 ...
 */
async function getKeybindingsForCommands(commandIds) {
	const keybindings = {}
...
async function getKeybindingForCommand(commandId) {
	try {
		const userKeybindings = await (0, vscode_config_1.readUserConfigFile)("keybindings.json")
 ...
 */
function getDefaultKeybindingForCommand(commandId) {
	const keybindings = package_json_1.default.contributes?.keybindings
