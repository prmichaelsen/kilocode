...
describe("parseXml", () => {
	describe("type conversion", () => {
      ...
      `
			const result = (0, xml_1.parseXml)(xml)
	...
	describe("basic functionality", () => {
      ...
      `
			const result = (0, xml_1.parseXml)(xml, ["nestedXml"])
...
describe("parseXmlForDiff", () => {
	describe("HTML entity handling", () => {
      ...
      `
			const result = (0, xml_1.parseXmlForDiff)(xml)
	...
	describe("basic functionality (same as parseXml)", () => {
      ...
      `
			const result = (0, xml_1.parseXmlForDiff)(xml, ["nestedXml"])
			expect(result.root.data.nestedXml).toBeTruthy()
			expect(result.root.data.nestedXml).toHaveProperty("item", "Should not parse this")
		})
	})
	describe("diff-specific use case", () => {
      ...
      `
			const result = (0, xml_1.parseXmlForDiff)(xml, ["file.diff.content"])
