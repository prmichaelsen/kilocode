...
const NotificationService_1 = require("./kilocode/NotificationService")
...
class McpHub {
	constructor(provider) {
		...
		Object.defineProperty(this, "settingsWatcher", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "fileWatchers", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: new Map(),
		})
		Object.defineProperty(this, "projectMcpWatcher", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "kiloNotificationService", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: new NotificationService_1.NotificationService(),
		})
		Object.defineProperty(this, "refCount", {
			...
			writable: true,
			value: 0,
		}) // Reference counter for active clients
		Object.defineProperty(this, "configChangeDebounceTimers", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: new Map(),
