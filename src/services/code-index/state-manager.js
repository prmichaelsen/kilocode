...
class CodeIndexStateManager {
	constructor() {
		Object.defineProperty(this, "_systemStatus", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: "Standby",
		...
		Object.defineProperty(this, "_processedItems", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "_totalItems", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "_currentItemUnit", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: "blocks",
		})
		Object.defineProperty(this, "_progressEmitter", {
			enumerable: true,
			configurable: true,
			writable: true,
		...
		Object.defineProperty(this, "onProgressUpdate", {
			...
			configurable: true,
			writable: true,
			value: this._progressEmitter.event,
		})
	}
	get state() {
