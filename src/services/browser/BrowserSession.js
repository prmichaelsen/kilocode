...
// Timeout constants
const BROWSER_NAVIGATION_TIMEOUT = 15000 // 15 seconds
class BrowserSession {
	constructor(context) {
		...
		Object.defineProperty(this, "lastConnectionAttempt", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "isUsingRemoteBrowser", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
	...
	async connectToRemoteBrowser() {
		...
		if (cachedChromeHostUrl && this.lastConnectionAttempt && Date.now() - this.lastConnectionAttempt < 3600000) {
	...
	async waitTillHTMLStable(page, timeout = 5000) {
