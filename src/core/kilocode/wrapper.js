...
exports.getKiloCodeWrapperProperties = void 0
const vscode = __importStar(require("vscode"))
const wrapper_1 = require("../../shared/kilocode/wrapper")
const getKiloCodeWrapperProperties = () => {
	...
	if (kiloCodeWrapped) {
		...
		kiloCodeWrapperTitle = wrapper_1.JETBRAIN_PRODUCTS[kiloCodeWrapperCode]?.name || "JetBrains IDE"
	}
	return {
		kiloCodeWrapped,
		kiloCodeWrapper,
...
exports.getKiloCodeWrapperProperties = getKiloCodeWrapperProperties
