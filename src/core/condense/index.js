...
async function summarizeConversation(
	...
	telemetry_1.TelemetryService.instance.captureContextCondensed(
		taskId,
	...
	if (messagesToSummarize.length <= 1) {
		...
		const error =
			messages.length <= exports.N_MESSAGES_TO_KEEP + 1
				? (0, i18n_1.t)("common:errors.condense_not_enough_messages", {
						prevContextTokens,
						messageCount: messages.length,
						minimumMessageCount: exports.N_MESSAGES_TO_KEEP + 2,
					})
	...
	const requestMessages = (0, image_cleaning_1.maybeRemoveImageBlocks)(
	...
	if (newContextTokens >= prevContextTokens) {
		...
		const error = (0, i18n_1.t)("common:errors.condense_context_grew", { prevContextTokens, newContextTokens })
		return { ...response, cost, error }
	}
