...
const RooProtectedController_1 = require("../RooProtectedController")
describe("RooProtectedController", () => {
	const TEST_CWD = "/test/workspace"
	let controller
	beforeEach(() => {
		controller = new RooProtectedController_1.RooProtectedController(TEST_CWD)
	})
	describe("isWriteProtected", () => {
		...
		it("should handle absolute paths by converting to relative", () => {
			const absolutePath = path_1.default.join(TEST_CWD, ".rooignore")
	...
	describe("getProtectedPatterns", () => {
		it("should return the list of protected patterns", () => {
			const patterns = RooProtectedController_1.RooProtectedController.getProtectedPatterns()
