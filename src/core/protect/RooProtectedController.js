...
class RooProtectedController {
	...
	getInstructions() {
		...
		return `# Protected Files\n\n(The following Kilo Code configuration file patterns are write-protected and always require approval for modifications, regardless of autoapproval settings. When using list_files, you'll notice a ${exports.SHIELD_SYMBOL} next to files that are write-protected.)\n\nProtected patterns: ${patterns}`
	}
	/**
...
Object.defineProperty(RooProtectedController, "PROTECTED_PATTERNS", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: [
