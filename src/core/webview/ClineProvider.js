...
const getKilocodeDefaultModel_1 = require("../../api/providers/kilocode/getKilocodeDefaultModel")
const wrapper_1 = require("../../core/kilocode/wrapper")
class ClineProvider extends events_1.default {
	constructor(context, outputChannel, renderContext = "sidebar", contextProxy, mdmService) {
		...
		Object.defineProperty(this, "webviewDisposables", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		...
		Object.defineProperty(this, "clineStack", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "codeIndexStatusSubscription", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "codeIndexManager", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "_workspaceTracker", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		}) // workSpaceTracker read-only for access outside this class
		Object.defineProperty(this, "mcpHub", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		}) // Change from private to protected
		Object.defineProperty(this, "marketplaceManager", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "mdmService", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "taskCreationCallback", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "taskEventListeners", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: new WeakMap(),
		})
		Object.defineProperty(this, "currentWorkspacePath", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "recentTasksCache", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "isViewLaunched", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "settingsImportedAt", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "latestAnnouncementId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: "sep-2025-code-supernova-1m",
		}) // Code Supernova 1M context window announcement
		Object.defineProperty(this, "providerSettingsManager", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "customModesManager", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		 ...
		 */
		Object.defineProperty(this, "handleCloudSettingsUpdate", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: async () => {
		...
		// Telemetry
		Object.defineProperty(this, "_appProperties", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "_gitProperties", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "kiloCodeTaskHistoryVersion", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "kiloCodeTaskHistorySizeForTelemetryOnly", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		...
		this.taskCreationCallback = (instance) => {
			...
			const onTaskCompleted = (taskId, tokenUsage, toolUsage) =>
				this.emit(types_1.RooCodeEventName.TaskCompleted, taskId, tokenUsage, toolUsage)
			...
			const onTaskTokenUsageUpdated = (taskId, tokenUsage) =>
				this.emit(types_1.RooCodeEventName.TaskTokenUsageUpdated, taskId, tokenUsage)
    ...
    */
	...
	async getHMRHtmlContent(webview) {
		...
		const iconsUri = (0, getUri_1.getUri)(webview, this.contextProxy.extensionUri, ["assets", "icons"]) // kilocode_change
	...
	getHtmlContent(webview) {
		...
		const imagesUri = (0, getUri_1.getUri)(webview, this.contextProxy.extensionUri, ["assets", "images"])
		const iconsUri = (0, getUri_1.getUri)(webview, this.contextProxy.extensionUri, ["assets", "icons"]) // kilocode_changes
		const audioUri = (0, getUri_1.getUri)(webview, this.contextProxy.extensionUri, ["webview-ui", "audio"])
	...
	setWebviewMessageListener(webview) {
		const onReceiveMessage = async (message) =>
			(0, webviewMessageHandler_1.webviewMessageHandler)(this, message, this.marketplaceManager)
	...
	async upsertProviderProfile(name, providerSettings, activate = true) {
		try {
			...
			if (activate) {
				...
				await telemetry_1.TelemetryService.instance.updateIdentity(providerSettings.kilocodeToken ?? "") // kilocode_change
			} else {
				await this.updateGlobalState("listApiConfigMeta", await this.providerSettingsManager.listConfig())
			}
			await this.postStateToWebview()
	...
	async ensureMcpServersDirectoryExists() {
		...
		if (process.platform === "win32") {
			...
			mcpServersDir = path.join(os_1.default.homedir(), "AppData", "Roaming", "Kilo-Code", "MCP")
		} else if (process.platform === "darwin") {
			// macOS: ~/Documents/Kilo-Code/MCP
			mcpServersDir = path.join(os_1.default.homedir(), "Documents", "Kilo-Code", "MCP")
		} else {
			// Linux: ~/.local/share/Kilo-Code/MCP
			mcpServersDir = path.join(os_1.default.homedir(), ".local", "share", "Kilo-Code", "MCP")
		}
		try {
			await promises_1.default.mkdir(mcpServersDir, { recursive: true })
		} catch (error) {
			// Fallback to a relative path if directory creation fails
			return path.join(os_1.default.homedir(), ".kilocode", "mcp")
		}
		return mcpServersDir
	}
	async ensureSettingsDirectoryExists() {
		const { getSettingsDirectoryPath } = await Promise.resolve().then(() =>
	...
	async handleKiloCodeCallback(token) {
		...
		if (this.getCurrentTask()) {
			this.getCurrentTask().api = (0, api_1.buildApiHandler)({
				apiProvider: kilocode,
				kilocodeToken: token,
			})
		}
	...
	async getTaskWithId(id) {
		...
		if (historyItem) {
			const { getTaskDirectoryPath } = await Promise.resolve().then(() =>
				__importStar(require("../../utils/storage")),
			)
			const globalStoragePath = this.contextProxy.globalStorageUri.fsPath
	...
	async postRulesDataToWebview() {
		...
		if (workspacePath) {
			this.postMessageToWebview({
				type: "rulesData",
				...(await (0, kilorules_1.getEnabledRules)(workspacePath, this.contextProxy, this.context)),
			})
		}
	}
	// kilocode_change end
	...
	async getStateToPostToWebview() {
		...
		const kiloCodeWrapperProperties = (0, wrapper_1.getKiloCodeWrapperProperties)()
		...
		return {
			...
			kilocodeDefaultModel: await (0, getKilocodeDefaultModel_1.getKilocodeDefaultModel)(
			...
			terminalOutputCharacterLimit:
				terminalOutputCharacterLimit ?? types_1.DEFAULT_TERMINAL_OUTPUT_CHARACTER_LIMIT,
			terminalShellIntegrationTimeout:
				terminalShellIntegrationTimeout ?? Terminal_1.Terminal.defaultShellIntegrationTimeout,
	...
	async getState() {
		...
		return {
			...
			terminalOutputCharacterLimit:
				stateValues.terminalOutputCharacterLimit ?? types_1.DEFAULT_TERMINAL_OUTPUT_CHARACTER_LIMIT,
			terminalShellIntegrationTimeout:
	...
	async getTelemetryProperties() {
		...
		async function getModelId() {
			try {
				if (task?.api instanceof providers_1.OpenRouterHandler) {
				...
				return {
					modelException: (0, errorUtils_1.stringifyError)(error),
				}
			}
		}
		...
		function getMemory() {
			try {
				...
				return {
					memoryException: (0, errorUtils_1.stringifyError)(error),
				}
			}
		}
		const getFastApply = () => {
			try {
				...
				return {
					fastApplyException: (0, errorUtils_1.stringifyError)(error),
				}
			}
		}
		// kilocode_change end
	...
	async fetchMcpMarketplaceFromApi(silent = false) {
		try {
			const response = await axios_1.default.get("https://api.cline.bot/v1/mcp/marketplace", {
				headers: {
...
- Use "${mcpDetails.mcpId}" as the server name in ${globalFileNames_1.GlobalFileNames.mcpSettings}.
...
Object.defineProperty(ClineProvider, "sideBarId", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: `${package_1.Package.name}.SidebarProvider`,
})
Object.defineProperty(ClineProvider, "tabPanelId", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: `${package_1.Package.name}.TabPanelProvider`,
})
Object.defineProperty(ClineProvider, "activeInstances", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: new Set(),
})
Object.defineProperty(ClineProvider, "PENDING_OPERATION_TIMEOUT_MS", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: 30000,
