...
describe("read_file tool with maxReadFileLine setting", () => {
	...
	const mockedCountFileLines = vi.mocked(line_counter_1.countFileLines)
	const mockedReadLines = vi.mocked(read_lines_1.readLines)
	const mockedExtractTextFromFile = vi.mocked(extract_text_1.extractTextFromFile)
	const mockedParseSourceCodeDefinitionsForFile = vi.mocked(tree_sitter_1.parseSourceCodeDefinitionsForFile)
