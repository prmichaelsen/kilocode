...
class AssistantMessageParser {
	 ...
	 */
	constructor() {
		Object.defineProperty(this, "contentBlocks", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "currentTextContent", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: undefined,
		})
		Object.defineProperty(this, "currentTextContentStartIndex", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "currentToolUse", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: undefined,
		})
		Object.defineProperty(this, "currentToolUseStartIndex", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "currentParamName", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: undefined,
		})
		Object.defineProperty(this, "currentParamValueStartIndex", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "MAX_ACCUMULATOR_SIZE", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 1024 * 1024,
		}) // 1MB limit
		Object.defineProperty(this, "MAX_PARAM_LENGTH", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 1024 * 100,
		}) // 100KB per parameter limit
