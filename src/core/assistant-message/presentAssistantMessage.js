...
const searchAndReplaceTool_1 = require("../tools/searchAndReplaceTool")
const editFileTool_1 = require("../tools/editFileTool") // kilocode_change: Morph fast apply
...
const newRuleTool_1 = require("../tools/newRuleTool") // kilocode_change
const reportBugTool_1 = require("../tools/reportBugTool") // kilocode_change
const condenseTool_1 = require("../tools/condenseTool") // kilocode_change
...
const kilocode_1 = require("../kilocode")
/**
 ...
 */
async function presentAssistantMessage(cline, recursionDepth = 0 /*kilocode_change*/) {
	if (cline.abort) {
	...
	const block = (0, clone_deep_1.default)(cline.assistantMessageContent[cline.currentStreamingContentIndex]) // need to create copy bc while stream is updating the array, it could be updating the reference block properties too
	switch (block.type) {
		case "text": {
		...
		case "tool_use":
				...
				switch (block.name) {
					...
					case "read_file":
						...
						if ((0, types_1.shouldUseSingleFileRead)(modelId)) {
							...
							return (0, readFileTool_1.getReadFileToolDescription)(block.name, block.params)
						}
			...
			const askApproval = async (type, partialMessage, progressStatus, isProtected) => {
				...
				if (text) {
					...
					pushToolResult(
						responses_1.formatResponse.toolResult(
							responses_1.formatResponse.toolApprovedWithFeedback(text),
							images,
						),
					)
				}
			...
			switch (block.name) {
				case "write_to_file":
					...
					break
				case "update_todo_list":
					await (0, updateTodoListTool_1.updateTodoListTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				case "apply_diff": {
					...
					if (provider) {
						...
						isMultiFileApplyDiffEnabled = experiments_1.experiments.isEnabled(
							state.experiments ?? {},
					...
					if (isMultiFileApplyDiffEnabled) {
						...
						await checkpointSaveAndMark(cline)
						await (0, applyDiffTool_1.applyDiffToolLegacy)(
							cline,
							block,
							askApproval,
							handleError,
				...
				case "search_and_replace":
					await checkpointSaveAndMark(cline)
					await (0, searchAndReplaceTool_1.searchAndReplaceTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				case "edit_file":
					await checkpointSaveAndMark(cline)
					await (0, editFileTool_1.editFileTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				case "read_file":
					...
					const modelId = cline.api.getModel().id
					if ((0, types_1.shouldUseSingleFileRead)(modelId)) {
						await (0, simpleReadFileTool_1.simpleReadFileTool)(
							cline,
							block,
							askApproval,
							handleError,
						...
						await (0, readFileTool_1.readFileTool)(
							cline,
							block,
							askApproval,
							handleError,
					...
					break
				case "fetch_instructions":
					await (0, fetchInstructionsTool_1.fetchInstructionsTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "list_files":
					await (0, listFilesTool_1.listFilesTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				case "codebase_search":
					...
					break
				case "list_code_definition_names":
					await (0, listCodeDefinitionNamesTool_1.listCodeDefinitionNamesTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "search_files":
					await (0, searchFilesTool_1.searchFilesTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "browser_action":
					await (0, browserActionTool_1.browserActionTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				case "execute_command":
					...
					break
				case "use_mcp_tool":
					await (0, useMcpToolTool_1.useMcpToolTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "access_mcp_resource":
					await (0, accessMcpResourceTool_1.accessMcpResourceTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "ask_followup_question":
					await (0, askFollowupQuestionTool_1.askFollowupQuestionTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "switch_mode":
					await (0, switchModeTool_1.switchModeTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "new_task":
					await (0, newTaskTool_1.newTaskTool)(
						cline,
						block,
						askApproval,
						handleError,
				...
				// kilocode_change start
				case "new_rule":
					await (0, newRuleTool_1.newRuleTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "report_bug":
					await (0, reportBugTool_1.reportBugTool)(
						cline,
						block,
						askApproval,
						handleError,
					...
					break
				case "condense":
					await (0, condenseTool_1.condenseTool)(
						cline,
						block,
						askApproval,
						handleError,
	...
	if (!block.partial || cline.didRejectTool || cline.didAlreadyUseTool) {
		...
		if (cline.currentStreamingContentIndex < cline.assistantMessageContent.length) {
			...
			await (0, kilocode_1.yieldPromise)()
