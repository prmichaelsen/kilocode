...
const parseAssistantMessage_1 = require("../parseAssistantMessage")
const parseAssistantMessageV2_1 = require("../parseAssistantMessageV2")
...
const runBenchmark = () => {
	...
	for (const testCase of testCases) {
		const v1Time = measureExecutionTime(parseAssistantMessage_1.parseAssistantMessage, testCase.input)
		const v2Time = measureExecutionTime(parseAssistantMessageV2_1.parseAssistantMessageV2, testCase.input)
		const timeRatio = v1Time / v2Time
		const v1Memory = measureMemoryUsage(parseAssistantMessage_1.parseAssistantMessage, testCase.input)
		const v2Memory = measureMemoryUsage(parseAssistantMessageV2_1.parseAssistantMessageV2, testCase.input)
		console.log(
