...
exports.parseAssistantMessageV2 = parseAssistantMessageV2
 ...
 *          `true`.
 */
function parseAssistantMessageV2(assistantMessage) {
	const contentBlocks = []
	...
	for (const name of types_1.toolNames) {
		toolUseOpenTags.set(`<${name}>`, name)
	}
	for (const name of tools_1.toolParamNames) {
