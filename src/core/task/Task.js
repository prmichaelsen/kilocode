...
const processKiloUserContentMentions_1 = require("../mentions/processKiloUserContentMentions") // kilocode_change
const workflows_1 = require("../context/instructions/workflows") // kilocode_change
const mentions_1 = require("../mentions") // kilocode_change
const kilo_1 = require("../slash-commands/kilo") // kilocode_change
const globalFileNames_1 = require("../../shared/globalFileNames") // kilocode_change
const kilo_rules_1 = require("../context/instructions/kilo-rules") // kilocode_change
...
class Task extends events_1.default {
	...
	constructor({
		...
		Object.defineProperty(this, "taskIsFavorited", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		}) // kilocode_change
		Object.defineProperty(this, "rootTaskId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "parentTaskId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "childTaskId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "rootTask", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		 ...
		 */
		Object.defineProperty(this, "_taskMode", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		 ...
		 */
		Object.defineProperty(this, "taskModeReady", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		// TaskStatus
		Object.defineProperty(this, "idleAsk", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "resumableAsk", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "interactiveAsk", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "didFinishAbortingStream", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		...
		Object.defineProperty(this, "abortReason", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "pausedModeSlug", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: modes_1.defaultModeSlug,
		})
		Object.defineProperty(this, "pauseInterval", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "autoApprovalHandler", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "toolRepetitionDetector", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "rooIgnoreController", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "rooProtectedController", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "fileContextTracker", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "urlContentFetcher", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "terminalProcess", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		// Computer User
		Object.defineProperty(this, "browserSession", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		// Editing
		Object.defineProperty(this, "diffViewProvider", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "diffStrategy", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "fuzzyMatchThreshold", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "didEditFile", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		...
		Object.defineProperty(this, "apiConversationHistory", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "clineMessages", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		...
		// Ask
		Object.defineProperty(this, "askResponse", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "askResponseText", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "askResponseImages", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "lastMessageTs", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		// Tool Use
		Object.defineProperty(this, "consecutiveMistakeCount", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "consecutiveMistakeLimit", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "consecutiveMistakeCountForApplyDiff", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: new Map(),
		})
		Object.defineProperty(this, "toolUsage", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: {},
		...
		// Checkpoints
		Object.defineProperty(this, "enableCheckpoints", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "checkpointService", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "checkpointServiceInitializing", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		...
		// Task Bridge
		Object.defineProperty(this, "enableBridge", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "messageQueueService", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "messageQueueStateChangedHandler", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		// Streaming
		Object.defineProperty(this, "isWaitingForFirstChunk", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		...
		Object.defineProperty(this, "currentStreamingContentIndex", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "currentStreamingDidCheckpoint", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "assistantMessageContent", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "presentAssistantMessageLocked", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "presentAssistantMessageHasPendingUpdates", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "userMessageContent", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "userMessageContentReady", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "didRejectTool", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "didAlreadyUseTool", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "didCompleteReadingStream", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		})
		Object.defineProperty(this, "assistantMessageParser", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "lastUsedInstructions", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "skipPrevResponseIdOnce", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		...
		// Token Usage Cache
		Object.defineProperty(this, "tokenUsageSnapshot", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "tokenUsageSnapshotAt", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		this.workspacePath = parentTask
			...
			: (workspacePath ?? (0, path_1.getWorkspacePath)(path.join(os_1.default.homedir(), "Documents"))) // kilocode_change: use Documents instead of Desktop as default
		...
		this.autoApprovalHandler = new AutoApprovalHandler_1.AutoApprovalHandler()
		...
		this.assistantMessageParser = new AssistantMessageParser_1.AssistantMessageParser()
		...
		if (this.diffEnabled) {
			...
			provider.getState().then((state) => {
				const isMultiFileApplyDiffEnabled = experiments_1.experiments.isEnabled(
					state.experiments ?? {},
					experiments_1.EXPERIMENT_IDS.MULTI_FILE_APPLY_DIFF,
				)
				if (isMultiFileApplyDiffEnabled) {
					this.diffStrategy = new multi_file_search_replace_1.MultiFileSearchReplaceDiffStrategy(
	...
	async ask(type, text, partial, progressStatus, isProtected) {
		...
		await (0, p_wait_for_1.default)(() => this.askResponse !== undefined || this.lastMessageTs !== askTs, {
			interval: 100,
		})
	...
	async sayAndCreateMissingParamError(toolName, paramName, relPath) {
		const kilocodeExtraText = (() => {
			switch (toolName) {
				case "apply_diff":
					return (0, i18n_1.t)("kilocode:task.disableApplyDiff") + " "
				case "edit_file":
					return (0, i18n_1.t)("kilocode:task.disableEditFile") + " "
				default:
					return ""
			}
		})()
	...
	async resumeTaskFromHistory() {
		...
		const gpt5Messages = modifiedClineMessages.filter(
			(m) => m.type === "say" && m.say === "text" && !!m.metadata?.gpt5?.previous_response_id,
		)
			...
			if (Array.isArray(message.content)) {
				const newContent = message.content.map((block) => {
					if (block.type === "tool_use") {
						...
						const toolName = (0, export_markdown_1.findToolName)(
							block.tool_use_id,
		...
		while (stack.length > 0) {
			...
			await this.say(
				...
				JSON.stringify({
					request:
						currentUserContent
							.map((block) => (0, export_markdown_1.formatContentBlockToMarkdown)(block))
							.join("\n\n") + "\n\nLoading...",
					apiProtocol,
				}),
			)
			...
			// kilocode_change start
			const [parsedUserContent, needsRulesFileCheck] = await (0,
			processKiloUserContentMentions_1.processKiloUserContentMentions)({
			...
			try {
				...
				if (assistantMessage.length > 0) {
					...
					if (!didToolUse) {
						this.userMessageContent.push({ type: "text", text: responses_1.formatResponse.noToolsUsed() })
						this.consecutiveMistakeCount++
					}
					...
					// an error.
					await this.say("error", (0, i18n_1.t)("kilocode:task.noAssistantMessages"))
					// kilocode_change start
					telemetry_1.TelemetryService.instance.captureEvent(types_1.TelemetryEventName.NO_ASSISTANT_MESSAGES)
					// kilocode_change end
					await this.addToApiConversationHistory({
						role: "assistant",
	...
	async loadContext(userContent, includeFileDetails = false) {
		...
		// bookmark
		const { localWorkflowToggles, globalWorkflowToggles } = await (0, workflows_1.refreshWorkflowToggles)(
			this.getContext(),
			this.cwd,
		)
				...
				userContent.map(async (block) => {
					if (block.type === "text") {
						...
						if (
							...
							const parsedText = await (0, mentions_1.parseMentions)(
								block.text,
								this.cwd,
							...
							const { processedText, needsRulesFileCheck: needsCheck } = await (0,
							kilo_1.parseKiloSlashCommands)(parsedText, localWorkflowToggles, globalWorkflowToggles)
							if (needsCheck) {
		...
		const [processedUserContent, environmentDetails] = await Promise.all([
			processUserContent(),
			(0, getEnvironmentDetails_1.getEnvironmentDetails)(this, includeFileDetails),
		])
		...
		if (needsClinerulesFileCheck) {
			clinerulesError = await (0, kilo_rules_1.ensureLocalKilorulesDirExists)(
				this.cwd,
				globalFileNames_1.GlobalFileNames.kiloRules,
			)
		}
		// Return all results
	...
	/*private kilocode_change*/ async getSystemPrompt() {
		...
		if (mcpEnabled ?? true) {
			...
			await (0, p_wait_for_1.default)(() => !mcpHub.isConnecting, { timeout: 10000 }).catch(() => {
	...
	async handleContextWindowExceededError() {
		...
		const truncateResult = await (0, sliding_window_1.truncateConversationIfNeeded)({
			messages: this.apiConversationHistory,
	...
	async *attemptApiRequest(retryAttempt = 0) {
		...
		let cleanConversationHistory = (0, image_cleaning_1.maybeRemoveImageBlocks)(
		...
		try {
			...
			if (modelId && modelId.startsWith("gpt-5") && !this.skipPrevResponseIdOnce) {
				...
				const idx = (0, array_1.findLastIndex)(
					this.clineMessages,
					(m) => m.type === "say" && m.say === "text" && !!m.metadata?.gpt5?.previous_response_id,
				)
				if (idx !== -1) {
		...
		try {
			...
			this.isWaitingForFirstChunk = false
			// kilocode_change start
			if (apiConfiguration?.apiProvider === "kilocode" && (0, errorUtils_1.isAnyRecognizedKiloCodeError)(error)) {
				const { response } = await ((0, errorUtils_1.isPaymentRequiredError)(error)
					? this.ask(
							"payment_required_prompt",
							JSON.stringify({
								title: error.error?.title ?? (0, i18n_1.t)("kilocode:lowCreditWarning.title"),
								message: error.error?.message ?? (0, i18n_1.t)("kilocode:lowCreditWarning.message"),
	...
	recordToolError(toolName, error) {
		...
		telemetry_1.TelemetryService.instance.captureEvent(types_1.TelemetryEventName.TOOL_ERROR, { toolName, error }) // kilocode_change
	}
	/**
