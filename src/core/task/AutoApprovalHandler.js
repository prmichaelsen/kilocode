...
class AutoApprovalHandler {
	constructor() {
		Object.defineProperty(this, "consecutiveAutoApprovedRequestsCount", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
		})
		Object.defineProperty(this, "consecutiveAutoApprovedCost", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: 0,
	...
	async checkCostLimit(state, messages, askForApproval) {
		...
		this.consecutiveAutoApprovedCost = (0, getApiMetrics_1.getApiMetrics)(messages).totalCost
