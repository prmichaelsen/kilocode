...
function getRulesSection(cwd, supportsComputerUse, diffStrategy, codeIndexManager, clineProviderState) {
	...
	const codebaseSearchRule = isCodebaseSearchAvailable
		...
		: ""
	const kiloCodeUseMorph = (0, editFileTool_1.isFastApplyAvailable)(clineProviderState)
	return `====
...
${kiloCodeUseMorph ? (0, edit_file_1.getFastApplyEditingInstructions)((0, editFileTool_1.getFastApplyModelType)(clineProviderState)) : getEditingInstructions(diffStrategy)}
