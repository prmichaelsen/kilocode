...
describe("getObjectiveSection", () => {
	...
	describe("when codebase_search is available", () => {
		it("should include codebase_search first enforcement in thinking process", () => {
			const objective = (0, objective_1.getObjectiveSection)(mockCodeIndexManagerEnabled)
	...
	describe("when codebase_search is not available", () => {
		it("should not include codebase_search enforcement", () => {
			const objective = (0, objective_1.getObjectiveSection)(mockCodeIndexManagerDisabled)
	...
	it("should maintain proper structure regardless of codebase_search availability", () => {
		const objectiveEnabled = (0, objective_1.getObjectiveSection)(mockCodeIndexManagerEnabled)
		const objectiveDisabled = (0, objective_1.getObjectiveSection)(mockCodeIndexManagerDisabled)
