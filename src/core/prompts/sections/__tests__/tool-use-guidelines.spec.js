...
describe("getToolUseGuidelinesSection", () => {
	...
	describe("when codebase_search is available", () => {
		it("should include codebase_search first enforcement", () => {
			const guidelines = (0, tool_use_guidelines_1.getToolUseGuidelinesSection)(mockCodeIndexManagerEnabled)
	...
	describe("when codebase_search is not available", () => {
		it("should not include codebase_search enforcement", () => {
			const guidelines = (0, tool_use_guidelines_1.getToolUseGuidelinesSection)(mockCodeIndexManagerDisabled)
	...
	it("should include iterative process guidelines regardless of codebase_search availability", () => {
		const guidelinesEnabled = (0, tool_use_guidelines_1.getToolUseGuidelinesSection)(mockCodeIndexManagerEnabled)
		const guidelinesDisabled = (0, tool_use_guidelines_1.getToolUseGuidelinesSection)(mockCodeIndexManagerDisabled)
