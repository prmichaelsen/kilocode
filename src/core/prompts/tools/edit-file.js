...
exports.getFastApplyEditingInstructions = getFastApplyEditingInstructions
exports.getEditFileDescription = getEditFileDescription
function getFastApplyEditingInstructions(modelType) {
...
function getEditFileDescription() {
	return `## edit_file
