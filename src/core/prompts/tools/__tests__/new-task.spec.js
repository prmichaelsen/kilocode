...
describe("getNewTaskDescription", () => {
	it("should NOT show todos parameter at all when setting is disabled", () => {
		...
		const description = (0, new_task_1.getNewTaskDescription)(args)
	...
	it("should include todos in examples only when setting is enabled", () => {
		...
		const descriptionOff = (0, new_task_1.getNewTaskDescription)(argsWithSettingOff)
		const descriptionOn = (0, new_task_1.getNewTaskDescription)(argsWithSettingOn)
