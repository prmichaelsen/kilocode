...
const RooIgnoreController_1 = require("../RooIgnoreController")
...
describe("RooIgnoreController", () => {
	...
	beforeEach(() => {
		...
		// Create controller
		controller = new RooIgnoreController_1.RooIgnoreController(TEST_CWD)
	})
	...
	describe("validateAccess", () => {
		...
		it("should allow all access when no .kilocodeignore content", async () => {
			...
			mockFileExists.mockResolvedValue(false)
			const emptyController = new RooIgnoreController_1.RooIgnoreController(TEST_CWD)
