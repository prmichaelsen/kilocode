export const internationalZAiDefaultModelId = "glm-4.6"; // kilocode_change: overwrite the entire file on merge conflicts
export const internationalZAiModels = {
    ...
    "glm-4.6": {
        ...
        description: "GLM-4.6 is Zhipu's latest SOTA models for reasoning, code, and agentsUpgraded across 8 authoritative benchmarks. With a 355B-parameter MoE architecture and 200K context, it surpasses GLM-4.5 in coding, reasoning, search, writing, and agent applications.",
    },
    // kilocode_change end
    "glm-4.5": {
        maxTokens: 98_304,
...
export const mainlandZAiDefaultModelId = "glm-4.6"; // kilocode_change: overwrite the entire file on merge conflicts
