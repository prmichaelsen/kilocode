...
exports.MAX_SYSTEM_PROMPT_LENGTH = void 0
...
exports.MAX_SYSTEM_PROMPT_LENGTH = 65536
// kilocode_change end
...
async function generateTempSystemPrompt(options) {
	...
	const isSystemPromptTooLong = options.systemPrompt.length > exports.MAX_SYSTEM_PROMPT_LENGTH
	if (!isWindows && !isSystemPromptTooLong) {
		return undefined
	}
	const uniqueId = node_crypto_1.default.randomUUID()
	const tempFilePath = node_path_1.default.join(os.tmpdir(), `kilocode-system-prompt-${uniqueId}.txt`)
	await promises_1.default.writeFile(tempFilePath, options.systemPrompt, "utf8")
	return tempFilePath
}
async function unlinkTempSystemPrompt(systemPromptFile) {
	...
	await promises_1.default.unlink(systemPromptFile).catch(console.log)
}
// kilocode_change end
