...
class BaseTerminal {
	constructor(provider, id, cwd) {
		...
		Object.defineProperty(this, "initialCwd", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "streamClosed", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		Object.defineProperty(this, "completedProcesses", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
	...
	static compressTerminalOutput(input, lineLimit, characterLimit) {
		...
		return (0, extract_text_1.truncateOutput)(
			(0, extract_text_1.applyRunLengthEncoding)(processedInput),
			lineLimit,
			effectiveCharLimit,
		)
	}
...
Object.defineProperty(BaseTerminal, "defaultShellIntegrationTimeout", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: 5000,
})
Object.defineProperty(BaseTerminal, "shellIntegrationTimeout", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: BaseTerminal.defaultShellIntegrationTimeout,
})
Object.defineProperty(BaseTerminal, "shellIntegrationDisabled", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: false,
})
Object.defineProperty(BaseTerminal, "commandDelay", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: 0,
})
Object.defineProperty(BaseTerminal, "powershellCounter", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: false,
})
Object.defineProperty(BaseTerminal, "terminalZshClearEolMark", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: true,
})
Object.defineProperty(BaseTerminal, "terminalZshOhMy", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: false,
})
Object.defineProperty(BaseTerminal, "terminalZshP10k", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: false,
})
Object.defineProperty(BaseTerminal, "terminalZdotdir", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: false,
})
Object.defineProperty(BaseTerminal, "compressProgressBar", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: true,
