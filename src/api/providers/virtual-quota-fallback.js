...
exports.VirtualQuotaFallbackHandler = void 0
 ...
 */
class VirtualQuotaFallbackHandler {
	constructor(options) {
		...
		Object.defineProperty(this, "handlerConfigs", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: [],
		})
		Object.defineProperty(this, "activeHandler", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "activeProfileId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		...
		this.settingsManager = new ProviderSettingsManager_1.ProviderSettingsManager(
			ContextProxy_1.ContextProxy.instance.rawContext,
		)
		this.usage = usage_tracker_1.UsageTracker.getInstance()
	}
	async initialize() {
	...
	async loadConfiguredProfiles() {
		...
		for (let i = 0; i < profiles.length; i++) {
			...
			try {
				...
				const apiHandler = (0, index_1.buildApiHandler)(profileSettings)
				if (apiHandler) {
					// Only fetch model for OpenRouterHandler if it has the method
					if (
						apiHandler instanceof openrouter_1.OpenRouterHandler &&
						typeof apiHandler.fetchModel === "function"
					) {
						try {
...
exports.VirtualQuotaFallbackHandler = VirtualQuotaFallbackHandler
