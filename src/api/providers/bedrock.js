...
class AwsBedrockHandler extends base_provider_1.BaseProvider {
	constructor(options) {
		...
		Object.defineProperty(this, "arnInfo", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		 ...
		 *
		 *************************************************************************************/
		Object.defineProperty(this, "costModelConfig", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: {
		...
		Object.defineProperty(this, "previousCachePointPlacements", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: {},
	...
	convertToBedrockConverseMessages(
		...
		const cacheModelInfo = {
			...
			contextWindow: modelInfo?.contextWindow || 200000,
 ...
 */
Object.defineProperty(AwsBedrockHandler, "ERROR_TYPES", {
	enumerable: true,
	configurable: true,
	writable: true,
	value: {
