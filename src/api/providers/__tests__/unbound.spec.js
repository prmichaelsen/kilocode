...
describe("UnboundHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new unbound_1.UnboundHandler(mockOptions)
	...
	describe("constructor", () => {
		it("should initialize with provided options", async () => {
			expect(handler).toBeInstanceOf(unbound_1.UnboundHandler)
	...
	describe("completePrompt", () => {
		...
		it("should not set max_tokens for non-Anthropic models", async () => {
			mockCreate.mockClear()
			const nonAnthropicHandler = new unbound_1.UnboundHandler({
		...
		it("should not set temperature for openai/o3-mini", async () => {
			mockCreate.mockClear()
			const openaiHandler = new unbound_1.UnboundHandler({
	...
	describe("fetchModel", () => {
		...
		it("should return default model when invalid model provided", async () => {
			const handlerWithInvalidModel = new unbound_1.UnboundHandler({
				...mockOptions,
