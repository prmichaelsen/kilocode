...
describe("GeminiHandler", () => {
	...
	describe("getModel", () => {
		it("should return correct model info", () => {
			...
			expect(modelInfo.info.contextWindow).toBe(32767)
		})
	...
	describe("calculateCost", () => {
		...
		it("should calculate cost correctly based on input and output tokens", () => {
			...
			const expectedCost =
				(inputTokens / 1000000) * mockInfo.inputPrice + (outputTokens / 1000000) * mockInfo.outputPrice
		...
		it("should handle only input tokens", () => {
			...
			const expectedCost = (inputTokens / 1000000) * mockInfo.inputPrice
		...
		it("should handle only output tokens", () => {
			...
			// Added non-null assertion (!)
			const expectedCost = (outputTokens / 1000000) * mockInfo.outputPrice
		...
		it("should calculate cost with cache write tokens", () => {
			...
			const expectedInputCost = (inputTokens / 1000000) * mockInfo.inputPrice
			const expectedOutputCost = (outputTokens / 1000000) * mockInfo.outputPrice
			const expectedCacheWriteCost = mockInfo.cacheWritesPrice * (cacheWriteTokens / 1000000) * (CACHE_TTL / 60)
		...
		it("should calculate cost with cache read tokens", () => {
			...
			// Added non-null assertions (!)
			const expectedInputCost = (uncachedReadTokens / 1000000) * mockInfo.inputPrice
			const expectedOutputCost = (outputTokens / 1000000) * mockInfo.outputPrice
			const expectedCacheReadCost = mockInfo.cacheReadsPrice * (cacheReadTokens / 1000000)
