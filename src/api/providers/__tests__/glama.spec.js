...
describe("GlamaHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new glama_1.GlamaHandler(mockOptions)
	...
	describe("constructor", () => {
		it("should initialize with provided options", () => {
			expect(handler).toBeInstanceOf(glama_1.GlamaHandler)
	...
	describe("completePrompt", () => {
		...
		it("should not set max_tokens for non-Anthropic models", async () => {
			...
			const nonAnthropicHandler = new glama_1.GlamaHandler(nonAnthropicOptions)
	...
	describe("fetchModel", () => {
		it("should return model info", async () => {
			...
			expect(modelInfo.info.contextWindow).toBe(200000)
		})
		it("should return default model when invalid model provided", async () => {
			const handlerWithInvalidModel = new glama_1.GlamaHandler({ ...mockOptions, glamaModelId: "invalid/model" })
