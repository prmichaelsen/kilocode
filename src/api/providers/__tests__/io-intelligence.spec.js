...
describe("IOIntelligenceHandler", () => {
	...
	beforeEach(() => {
		...
		handler = new io_intelligence_1.IOIntelligenceHandler(mockOptions)
	})
	afterEach(() => {
		vi.restoreAllMocks()
	})
	it("should create OpenAI client with correct configuration", () => {
		...
		const handler = new io_intelligence_1.IOIntelligenceHandler({ ioIntelligenceApiKey })
		// Verify that the handler was created successfully
		expect(handler).toBeInstanceOf(io_intelligence_1.IOIntelligenceHandler)
	...
	it("should throw error when API key is missing", () => {
		...
		expect(() => new io_intelligence_1.IOIntelligenceHandler(optionsWithoutKey)).toThrow(
	...
	it("should return fallback model info when not in cache", () => {
		const handlerWithUnknownModel = new io_intelligence_1.IOIntelligenceHandler({
			...mockOptions,
			apiModelId: "meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8",
		})
	...
	it("should use default model when no model is specified", () => {
		const handlerWithoutModel = new io_intelligence_1.IOIntelligenceHandler({
			...mockOptions,
