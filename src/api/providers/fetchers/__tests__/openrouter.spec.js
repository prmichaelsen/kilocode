...
describe("OpenRouter API", () => {
	describe("getOpenRouterModels", () => {
		...
		it.skip("fetches models and validates schema", async () => {
			...
			const ourCachingModels = Array.from(types_1.OPEN_ROUTER_PROMPT_CACHING_MODELS).filter(
			...
			const expectedComputerUseModels = Array.from(types_1.OPEN_ROUTER_COMPUTER_USE_MODELS)
			...
			const expectedReasoningBudgetModels = Array.from(types_1.OPEN_ROUTER_REASONING_BUDGET_MODELS)
			...
			const expectedRequiredReasoningBudgetModels = Array.from(
				types_1.OPEN_ROUTER_REQUIRED_REASONING_BUDGET_MODELS,
			)
	...
	describe("getOpenRouterModelEndpoints", () => {
		it("fetches model endpoints and validates schema", async () => {
			const { nockDone } = await (0, nock_1.back)("openrouter-model-endpoints.json")
