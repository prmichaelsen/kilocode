...
// Define GitCommit interface locally to avoid dependency
interface GitCommit {
	hash: string
	message: string
	author: string
...
// Define KiloCodeWrapperProperties interface locally to avoid dependency
interface KiloCodeWrapperProperties {
	[key: string]: any
}
// kilocode_change end
