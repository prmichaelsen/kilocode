...
exports.condenseToolResponse =
	exports.reportBugToolResponse =
	exports.newRuleToolResponse =
	exports.newTaskToolResponse =
		void 0
const newTaskToolResponse = (userInput) => `<explicit_instructions type="new_task">
...
`
exports.newTaskToolResponse = newTaskToolResponse
const newRuleToolResponse = (userInput) => `<explicit_instructions type="new_rule">
...
`
exports.newRuleToolResponse = newRuleToolResponse
const reportBugToolResponse = (userInput) => `<explicit_instructions type="report_bug">
...
exports.reportBugToolResponse = reportBugToolResponse
const condenseToolResponse = (userInput) => `<explicit_instructions type="condense">
...
`
exports.condenseToolResponse = condenseToolResponse
