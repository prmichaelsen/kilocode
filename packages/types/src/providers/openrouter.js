...
exports.OPEN_ROUTER_REASONING_BUDGET_MODELS =
	exports.OPEN_ROUTER_REQUIRED_REASONING_BUDGET_MODELS =
	exports.OPEN_ROUTER_COMPUTER_USE_MODELS =
	exports.OPEN_ROUTER_PROMPT_CACHING_MODELS =
	exports.OPENROUTER_DEFAULT_PROVIDER_NAME =
	exports.openRouterDefaultModelInfo =
	exports.openRouterDefaultModelId =
		void 0
// https://openrouter.ai/models?order=newest&supported_parameters=tools
exports.openRouterDefaultModelId = "anthropic/claude-sonnet-4"
exports.openRouterDefaultModelInfo = {
	maxTokens: 8192,
...
exports.OPEN_ROUTER_PROMPT_CACHING_MODELS = new Set([
...
exports.OPEN_ROUTER_COMPUTER_USE_MODELS = new Set([
	"anthropic/claude-3.5-sonnet",
	"anthropic/claude-3.5-sonnet:beta",
	"anthropic/claude-3.7-sonnet",
	"anthropic/claude-3.7-sonnet:beta",
...
exports.OPEN_ROUTER_REQUIRED_REASONING_BUDGET_MODELS = new Set([
	"anthropic/claude-3.7-sonnet:thinking",
	"google/gemini-2.5-pro",
	"google/gemini-2.5-flash-preview-05-20:thinking",
])
exports.OPEN_ROUTER_REASONING_BUDGET_MODELS = new Set([
	"anthropic/claude-3.7-sonnet:beta",
	"anthropic/claude-opus-4",
	"anthropic/claude-opus-4.1",
	"anthropic/claude-sonnet-4",
