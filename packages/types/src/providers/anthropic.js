...
exports.ANTHROPIC_DEFAULT_MAX_TOKENS = exports.anthropicModels = exports.anthropicDefaultModelId = void 0
exports.anthropicDefaultModelId = "claude-sonnet-4-20250514"
exports.anthropicModels = {
	"claude-sonnet-4-5": {
		maxTokens: 64000, // Overridden to 8k if `enableReasoningEffort` is false.
		contextWindow: 200000, // Default 200K, extendable to 1M with beta flag 'context-1m-2025-08-07'
		supportsImages: true,
		...
		tiers: [
			{
				contextWindow: 1000000, // 1M tokens with beta flag
	...
	"claude-opus-4-1-20250805": {
		maxTokens: 32000, // kilocode_change: https://openrouter.ai/anthropic/claude-opus-4.1/providers
	...
	"claude-3-7-sonnet-20250219:thinking": {
		maxTokens: 128000, // Unlocked by passing `beta` flag to the model. Otherwise, it's 64k.
		contextWindow: 200000,
		supportsImages: true,
		supportsComputerUse: true,
		supportsPromptCache: true,
...
exports.ANTHROPIC_DEFAULT_MAX_TOKENS = 8192
