...
class RetryQueue extends events_1.EventEmitter {
	constructor(context, config, log, authHeaderProvider) {
		...
		Object.defineProperty(this, "STORAGE_KEY", {
			...
			configurable: true,
			writable: true,
			value: "roo.retryQueue",
		})
		Object.defineProperty(this, "authHeaderProvider", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		})
		Object.defineProperty(this, "queuePausedUntil", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		}) // Timestamp when the queue can resume processing
		Object.defineProperty(this, "isPaused", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		}) // Manual pause state (e.g., for auth state changes)
		Object.defineProperty(this, "currentUserId", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0,
		}) // Track current user ID for conditional clearing
		Object.defineProperty(this, "hasHadUser", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: false,
		}) // Track if we've ever had a user (to distinguish from first login)
