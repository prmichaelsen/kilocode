...
module.exports = function (webpackEnv) {
	...
	return {
		...
		resolve: {
			...
			plugins: [
				// Allow workspace imports for pnpm monorepo
				// Modified ModuleScopePlugin to allow imports from workspace packages
				...
				},
				{
					...
					oneOf: [
						...
						// The preset includes JSX, Flow, TypeScript, and some ESnext features.
						{
							...
							include: [
								paths.appSrc,
								// Include workspace packages for TypeScript compilation
								path.resolve(paths.appPath, "../../packages"),
							],
		...
		plugins: [
			...
			useTypeScript &&
				new ForkTsCheckerWebpackPlugin({
					...
					issue: {
						// Simplified patterns to avoid minimatch dependency conflicts
						include: [{ file: "src/**/*.ts" }, { file: "src/**/*.tsx" }],
						exclude: [
							{ file: "src/**/__tests__/**" },
							{ file: "src/**/*.test.ts" },
							{ file: "src/**/*.test.tsx" },
